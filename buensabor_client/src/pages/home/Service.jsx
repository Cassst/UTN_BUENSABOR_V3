...
const servicesList = [
  {
    id: 1,
    title: "Catering",
    desc: "Deleita a tus invitados con nuestros sabores y presentación",
    img: "/images/home/services/icon1.png",
  },
  {
    id: 2,
    title: "Delivery",
    desc: "Llevamos su pedido directamente a su puerta",
    img: "/images/home/services/icon2.png",
  },
  {
    id: 3,
    title: "Pedidos En Linea",
    desc: "Explore el menú y ordene con facilidad",
    img: "/images/home/services/icon3.png",
  },
  {
    id: 4,
    title: "Gift Cards",
    desc: "Regala una cena excepcional con nuestras tarjetas de regalo",
        ...
        <div className="md:w-1/2">
          <div className="text-left md:w-4/5">
            ...
            <p className="my-5 text-secondary leading-[30px]">
              Arraigados en la pasión, seleccionamos experiencias gastronómicas
              inolvidables y Ofrece servicios excepcionales, combinando arte
              culinario con calidez & hospitalidad.
            </p>
            <Link to="/contact">
              <button
