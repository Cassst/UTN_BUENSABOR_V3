...
const Banner = () => {
  return (
    <div className="max-w-screen-2xl container mx-auto x1:px-24 px-4 bg-gradient-to-r from-[#fafafa] from-0% to-[#fcfcfc] to-100%">
      <div className="py-24 flex flex-col md:flex-row-reverse justify-between items-center gap-8">
        {/*imagen*/}
        <div className="md:w-1/2">
          <img src="images/home/banner.png" alt="BannerImg" />
          <div className="flex flex-col md:flex-row items-center justify-around -mt-14 gap-6">
            ...
            <div className="sm:flex hidden py-2 px-3 rounded-2xl items-center gap-3 shadow-md w-64">
              <img
                src="images/home/b-food1.png"
                alt="menuBanner1"
                className="rounded-2xl"
